Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/brightec/CocoaSoundCloudUI.git', :tag => '1.0.9'}
  ...
  s.dependency 'SoundCloud-Cocoa-API', :git => 'https://github.com/mhuusko5/SoundCloud-Cocoa-API.git'
